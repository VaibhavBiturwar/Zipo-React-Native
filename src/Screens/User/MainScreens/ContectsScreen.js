...
import ChatListModel from "../ListModel/ChatListModel";
...
export default function ContectsScreen({ navigation }) {
	return (
		<View style={{ flex: 1, backgroundColor: "white" }}>
			<CustomStatusBar />
			<SimpleGreenBackButton2 navigation={navigation}>Chats</SimpleGreenBackButton2>
